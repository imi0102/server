class StringConstants {
    static get ERROR_REGISTERING_FAMILY_MEMBER() {
        return 'Error registering family member';
    }

    static get FAMILY_CODE_ALREADY_EXISTS() {
        return "Family code already exists";
    }

    static get FAMILY_CODE_ADDED_SUCCESSFULLY() {
        return 'Family code added successfully';
    }

    static get FAILED_TO_ADD_FAMILY_CODE() {
